# CLAUDE.md — 3D 滑板 Skateboard 3D(維護守則)
...
- `node scripts/verify-skate.mjs [outDir] [url]` Playwright 全流程截圖+抓 pageerror

## 收尾鐵則
- 每次部署 bump `public/sw.js` 的 `CACHE_NAME`(skateboard3d-nf1 → nf2…)。
